...
namespace Juancrrn\Carrier\Common\View;

use InvalidArgumentException;
use Juancrrn\Carrier\Common\App;
use Juancrrn\Carrier\Common\TemplateUtils;
use Juancrrn\Carrier\Common\View\Common\FooterPartView;
use Juancrrn\Carrier\Common\View\Common\HeaderPartView;
...
class ViewManager
{
    ...
    /**
     * @var string $currentPageName     Current page name
     */
    private $currentPageName;

    /**
     * @var string $currentPageId       Current page identifier
     */
